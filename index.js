...
module.exports = function(homebridge) {
    ...
    homebridge.registerPlatform("homebridge-mi-kiwi", "MiAqaraPlatform", MiAqaraPlatform, true);
}
...
function MiAqaraPlatform(log, config, api) {
    ...
    this.log.info("  GitHub: https://github.com/wuqiyu007/homebridge-mi-kiwi  ");
...
MiAqaraPlatform.prototype.registerPlatformAccessories = function(accessories) {
    var that = this;
    that.api.registerPlatformAccessories("homebridge-mi-kiwi", "MiAqaraPlatform", accessories);
...
MiAqaraPlatform.prototype.unregisterPlatformAccessories = function(accessories) {
    var that = this;
    that.api.unregisterPlatformAccessories("homebridge-mi-kiwi", "MiAqaraPlatform", accessories);
    accessories.forEach(function(accessory, index, arr) {
